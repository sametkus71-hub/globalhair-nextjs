            ...
            <div className="text-center space-y-6">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Button 
                  ...
                  onClick={() => router.push(language === 'nl' ? '/nl/haartransplantatie' : '/en/hair-transplant')}
                >
                ...
                <Button 
                  ...
                  onClick={() => router.push(language === 'nl' ? '/nl/v6-hairboost' : '/en/v6-hairboost')}
                >
                ...
                <Button 
                  ...
                  variant="secondary"
                  className="font-header"
                  onClick={() => router.push(language === 'nl' ? '/nl/form' : '/en/form')}
                >
