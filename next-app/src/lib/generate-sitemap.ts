...
const HREFLANG_MAPPINGS: Record<string, string> = {
  ...
  "/nl/v6-hairboost": "/en/v6-hairboost",
  "/nl/v6-hairboost/reviews": "/en/v6-hairboost/reviews",
  "/nl/v6-hairboost/how": "/en/v6-hairboost/how",
  "/nl/v6-hairboost/mission": "/en/v6-hairboost/mission",
  "/nl/v6-hairboost/contact": "/en/v6-hairboost/contact",
  "/nl/v6-hairboost/methods/recharge": "/en/v6-hairboost/methods/recharge",
  "/nl/v6-hairboost/methods/rescue": "/en/v6-hairboost/methods/rescue",
  "/nl/v6-hairboost/methods/reborn": "/en/v6-hairboost/methods/reborn",
