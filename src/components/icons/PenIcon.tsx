...
export const PenIcon = ({ className }: PenIconProps) => {
  return (
    <svg width="20" height="24" viewBox="0 0 33 40" fill="none" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" transform="matrix(-1,0,0,1,0,0)" className={className}>
