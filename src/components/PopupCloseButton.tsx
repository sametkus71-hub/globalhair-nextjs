...
export const PopupCloseButton: React.FC<PopupCloseButtonProps> = ({ 
  ...
  return (
    <button
      onClick={onClose}
      className={`fixed top-4 left-4 z-50 w-10 h-10 rounded-full bg-gray-400/60 hover:bg-gray-400/80 transition-colors flex items-center justify-center ${className}`}
