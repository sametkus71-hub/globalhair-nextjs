        ...
        <div className="locations" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', alignItems: 'start' }}>
          ...
          <article className="loc" style={{ textAlign: 'center' }}>
            <div className="loc-icons" style={{ display: 'flex', gap: '4px', justifyContent: 'center', marginBottom: '4px' }}>
              ...
              <div className="v6-badge" style={{ width: '12px', height: '12px', border: '1px solid rgba(255,255,255,0.8)', borderRadius: '2px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '6px', fontWeight: '700', color: 'rgba(255,255,255,0.9)' }}>V6</div>
            </div>
            <h2 className="city" style={{ margin: 0, fontWeight: 800, fontSize: '10px', color: 'rgba(255,255,255,0.95)' }}>Barendrecht</h2>
          ...
          <article className="loc" style={{ textAlign: 'center' }}>
            ...
            <h2 className="city" style={{ margin: 0, fontWeight: 800, fontSize: '10px', color: 'rgba(255,255,255,0.95)' }}>Leiden</h2>
      ...
      <div className="contact-pane" data-pane="tr" hidden={activeTab !== 'tr'} aria-labelledby="tab-tr">
        <div className="locations" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', alignItems: 'start' }}>
          ...
          <article className="loc" style={{ textAlign: 'center' }}>
            ...
            <h2 className="city" style={{ margin: 0, fontWeight: 800, fontSize: '10px', color: 'rgba(255,255,255,0.95)' }}>İstanbul</h2>
            <p className="addr" style={{ margin: '.1rem 0 .3rem', fontSize: '8px', color: 'rgba(255,255,255,0.95)' }}>Placeholder street 123, İstanbul</p>
          </article>

          {/* Ankara */}
          <article className="loc" style={{ textAlign: 'center' }}>
            <h2 className="city" style={{ margin: 0, fontWeight: 800, fontSize: '10px', color: 'rgba(255,255,255,0.95)' }}>Ankara</h2>
