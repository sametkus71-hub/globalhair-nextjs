      ...
      >
        ...
        <div className="w-full lg:max-w-[450px] lg:mx-auto">
          <div className="flex items-center">
            ...
            <a href="mailto:contact@globalhair.nl" className="flex-1 text-center text-white no-underline hover:opacity-100 transition-opacity" style={{ fontFamily: 'Inter', fontWeight: 300, fontSize: '11px', lineHeight: '120%', letterSpacing: '-4%', opacity: 0.9 }}>
