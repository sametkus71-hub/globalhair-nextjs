    ...
    <div className="w-full h-full relative bg-[#E4E5E0] flex flex-col">
      ...
      <div className="fixed right-3 sm:right-4 md:right-5 lg:right-6 bottom-20 sm:bottom-24 md:bottom-28 lg:bottom-32 xl:bottom-36 space-y-3 z-50">
        <button 
          ...
          className="w-11 h-11 sm:w-12 sm:h-12 bg-black/12 backdrop-blur-lg rounded-full flex items-center justify-center border border-white/50 hover:border-white/70 hover:bg-black/16 transition-all duration-200 cursor-pointer"
          style={{
        ...
        >
          <Headphones className="w-5 h-5 sm:w-6 sm:h-6 text-white/90" />
        </button>
        <button 
