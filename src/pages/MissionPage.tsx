  ...
  return <>
      ...
      <div className="absolute inset-0 w-full h-full bg-gray-900"></div>}
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-between px-6 py-8 pb-40">
          {/* Top container - Title */}
          <div className={`pt-20 text-center transition-all duration-500 ease-out ${titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white leading-[0.85] tracking-wider">
              BERKANT
            </h1>
            <h1 className="text-4xl md:text-5xl lg:text-6xl text-white leading-[0.85] tracking-wider font-medium">
              DURAL
            </h1>
          </div>
