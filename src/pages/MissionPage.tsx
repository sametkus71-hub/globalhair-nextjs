        ...
        <div className="min-h-[var(--app-height)]" style={{ background: '#E4E5E0' }}>
          ...
          <div className="pt-16 md:pt-20 pb-20 md:pb-32 px-6">
            <div className="max-w-2xl mx-auto min-h-[calc(var(--app-height)-8rem)] flex flex-col">
              ...
              {/* Video Section */}
              <div className={`flex-1 mb-8 md:mb-12 transition-all duration-500 ease-out ${
                contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
                <div className="w-full max-w-lg mx-auto aspect-video bg-gray-200/50 rounded-2xl flex items-center justify-center mb-8">
                  {/* Video Placeholder */}
                  <div className="w-16 h-16 rounded-full bg-gray-400/60 flex items-center justify-center">
                ...
                <div className="text-center space-y-6">
                  <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                    {t('mission.content.paragraph1')}
                  </p>
                  
                  <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                    {t('mission.content.paragraph2')}
                  </p>

                  <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                    {t('mission.content.paragraph3')}
                  </p>
                </div>
              </div>
