...
export const translations = {
  nl: {
    ...
    'meta.reviews.description': 'Bekijk echte ervaringen en resultaten van onze klanten. Foto\'s, video\'s en verhalen van haartransplantatie behandelingen.',
    'meta.contact.description': 'Neem contact op met GlobalHair Institute. Bezoek ons in Barendrecht, Leiden of Istanbul voor een persoonlijk consult.',
    'meta.booking.description': 'Plan uw gratis consult bij GlobalHair Institute. Kies tussen een TrichoScan of V6 Hairboost® consultatie.',
    'meta.berkant.description': 'Maak kennis met Berkant Dural, oprichter en medisch directeur van GlobalHair Institute. Expert in haartransplantatie.',
    'meta.ozlem.description': 'Maak kennis met Özlem Aslan, CPO van GlobalHair Institute. Persoonlijke begeleiding tijdens uw behandeltraject.',
    'meta.method.description': 'Ontdek de GHI Precision Method™ - onze exclusieve haartransplantatie techniek voor natuurlijke resultaten.',
    'meta.trajectory.description': 'Uw complete behandeltraject bij GlobalHair Institute. Van consult tot nazorg, wij begeleiden u elke stap.',
    'meta.package-standard.description': 'Ontdek ons Standard haartransplantatie pakket met FUE Saffier/DHI techniek en Comfort Verdoving.',
    'meta.package-premium.description': 'Ontdek ons Premium haartransplantatie pakket met GHI Stemcell Repair™ voor 20-35% meer dichtheid.',
    'meta.package-elite.description': 'Ontdek ons Elite haartransplantatie pakket met Full Comfort Anesthesia en V6 Hairboost® behandelingen.',
    'meta.privacy.description': 'Lees ons privacybeleid. Hoe GlobalHair Institute omgaat met uw persoonlijke gegevens.',
    'meta.terms.description': 'Algemene voorwaarden van GlobalHair Institute. Lees onze voorwaarden voor behandelingen en diensten.',
    'meta.notfound.description': 'Pagina niet gevonden. Ga terug naar de homepage van GlobalHair Institute.',
    'meta.review-item.description': 'Bekijk deze klantervaring en resultaten van een haartransplantatie bij GlobalHair Institute.',
    ...
    'page.reviews.title': 'Reviews & Resultaten',
    'page.contact.title': 'Contact',
    'page.booking.title': 'Afspraak Maken',
    'page.berkant.title': 'Berkant Dural - Oprichter',
    'page.ozlem.title': 'Özlem Aslan - CPO',
    'page.method.title': 'GHI Precision Method™',
    'page.trajectory.title': 'Behandeltraject',
    'page.package-standard.title': 'Standard Pakket',
    'page.package-premium.title': 'Premium Pakket',
    'page.package-elite.title': 'Elite Pakket',
    'page.privacy.title': 'Privacybeleid',
    'page.terms.title': 'Algemene Voorwaarden',
    'page.notfound.title': 'Pagina Niet Gevonden',
    'page.review-item.title': 'Klantervaring',
  ...
  en: {
    ...
    'meta.reviews.description': 'View real experiences and results from our customers. Photos, videos and stories from hair transplant treatments.',
    'meta.contact.description': 'Contact GlobalHair Institute. Visit us in Barendrecht, Leiden or Istanbul for a personal consultation.',
    'meta.booking.description': 'Schedule your free consultation at GlobalHair Institute. Choose between a TrichoScan or V6 Hairboost® consultation.',
    'meta.berkant.description': 'Meet Berkant Dural, founder and medical director of GlobalHair Institute. Expert in hair transplantation.',
    'meta.ozlem.description': 'Meet Özlem Aslan, CPO of GlobalHair Institute. Personal guidance throughout your treatment journey.',
    'meta.method.description': 'Discover the GHI Precision Method™ - our exclusive hair transplant technique for natural results.',
    'meta.trajectory.description': 'Your complete treatment journey at GlobalHair Institute. From consultation to aftercare, we guide you every step.',
    'meta.package-standard.description': 'Discover our Standard hair transplant package with FUE Sapphire/DHI technique and Comfort Anesthesia.',
    'meta.package-premium.description': 'Discover our Premium hair transplant package with GHI Stemcell Repair™ for 20-35% more density.',
    'meta.package-elite.description': 'Discover our Elite hair transplant package with Full Comfort Anesthesia and V6 Hairboost® treatments.',
    'meta.privacy.description': 'Read our privacy policy. How GlobalHair Institute handles your personal data.',
    'meta.terms.description': 'Terms and conditions of GlobalHair Institute. Read our terms for treatments and services.',
    'meta.notfound.description': 'Page not found. Return to the GlobalHair Institute homepage.',
    'meta.review-item.description': 'View this customer experience and results from a hair transplant at GlobalHair Institute.',
    
    // Pages
    'page.haartransplantatie.title': 'Hair Transplant',
    'page.v6hairboost.title': 'V6 Hairboost®',
    'page.coming-soon': 'Coming Soon',
    'page.reviews.title': 'Reviews & Results',
    'page.contact.title': 'Contact',
    'page.booking.title': 'Book Appointment',
    'page.berkant.title': 'Berkant Dural - Founder',
    'page.ozlem.title': 'Özlem Aslan - CPO',
    'page.method.title': 'GHI Precision Method™',
    'page.trajectory.title': 'Treatment Journey',
    'page.package-standard.title': 'Standard Package',
    'page.package-premium.title': 'Premium Package',
    'page.package-elite.title': 'Elite Package',
    'page.privacy.title': 'Privacy Policy',
    'page.terms.title': 'Terms & Conditions',
    'page.notfound.title': 'Page Not Found',
    'page.review-item.title': 'Customer Experience',
